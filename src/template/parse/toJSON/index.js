...
import {keyMakerWithFallthrough} from './02-keyMaker.js'
 ...
 */
const parserWithFallthrough = function (tmpl, order = [], fmt) {
  ...
  //name each value
  let obj = keyMakerWithFallthrough(arr, order)
...
export {parser as default, parserWithFallthrough}
